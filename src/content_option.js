...
const introdata = {
  ...
  description:
    "Программирование - это искусство, где бинарные нули и единицы становятся музыкой инноваций и гармонией технологий.",
  your_img_url: logo,
};
...
const contactConfig = {
  ...
  description:
    "Программисты - это архитекторы цифровой революции, строящие здания истории на фундаменте кода. ",
