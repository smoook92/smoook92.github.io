...
const dataabout = {
    ...
    aboutme: "Мне нравятся длительные рамки, когда я могу планировать свою работу, чтобы обеспечить нужный результат. У меня высокий уровень трудовой этики, поэтому я получаю удовольствие от выполнения задачи хорошо и вовремя.",
};
const worktimeline = [{
