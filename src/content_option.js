...
const dataabout = {
    ...
    aboutme: "Я - программист PHP, предпочитающий длительные рамки работы для тщательного планирования и достижения высоких результатов. Мой высокий уровень трудовой этики гарантирует выполнение задач качественно и вовремя.",
};
const worktimeline = [{
